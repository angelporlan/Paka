...
const Landing = () => {
  ...
  const stats = [
    { number: "50K+", label: "Productos escaneados", icon: <Database className="w-6 h-6" /> },
    { number: "10K+", label: "Usuarios activos", icon: <Users className="w-6 h-6" /> },
    { number: "4.8", label: "Valoración media", icon: <Star className="w-6 h-6" /> },
    { number: "99%", label: "Precisión del análisis", icon: <Award className="w-6 h-6" /> }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className={`space-y-8 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button asChild size="lg" className="text-lg px-8 py-4 rounded-full bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 shadow-lg hover:shadow-xl transition-all duration-300">
                  <Link to="/app">
                    Comenzar ahora
                    <ArrowRight className="ml-2 w-5 h-5" />
                  </Link>
                </Button>
                <Button variant="outline" size="lg" className="text-lg px-8 py-4 rounded-full border-2 hover:bg-gray-50 transition-all duration-300">
              ...
              <div className="relative mx-auto w-80 h-96 bg-gradient-to-br from-gray-900 to-gray-700 rounded-3xl p-2 shadow-2xl">
                <div className="w-full h-full bg-white rounded-2xl overflow-hidden">
                  ...
                  <div className="p-4 space-y-4">
                    <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg h-32 flex items-center justify-center relative">
                      <div className="absolute inset-0 bg-black bg-opacity-20 rounded-lg"></div>
                      <div className="relative z-10 text-center">
                        <Camera className="w-8 h-8 text-gray-500 mx-auto mb-2" />
                        <p className="text-xs text-gray-600">Apunta al código de barras</p>
                      </div>
                      {/* Scanning animation */}
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                <div className="bg-gradient-to-br from-green-100 to-blue-100 text-green-600 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                  {stat.icon}
                </div>
            ...
            {benefits.map((benefit, index) => (
              ...
              >
                <CardContent className="p-8 text-center">
                  <div className="bg-gradient-to-br from-green-100 to-blue-100 text-green-600 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:bg-gradient-to-br group-hover:from-green-600 group-hover:to-blue-600 group-hover:text-white transition-all duration-300">
                    {benefit.icon}
                  </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="text-lg px-12 py-4 rounded-full bg-white text-green-600 hover:bg-gray-100 shadow-lg hover:shadow-xl transition-all duration-300">
                <Link to="/app">
                  Comenzar gratis ahora
                  <ArrowRight className="ml-2 w-5 h-5" />
                </Link>
              </Button>
              <Button variant="outline" size="lg" className="text-lg px-12 py-4 rounded-full border-2 border-white text-black hover:bg-white hover:text-green-600 transition-all duration-300">
                <Download className="mr-2 w-5 h-5" />
                Descargar app (En desarrollo)
              </Button>
            </div>
